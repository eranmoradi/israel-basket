...
export default function HomePage() {
  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-8">
      {/* Hero */}
      <div className="rounded-3xl bg-gradient-to-bl from-blue-900 to-blue-700 text-white px-8 py-14 sm:py-20 text-center mb-8 shadow-lg">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-8">
        <button
          ...
          className="bg-blue-700 text-white font-bold text-base py-3.5 rounded-xl shadow-md hover:bg-blue-600 active:scale-95 transition-all"
        >
          📦 רשימת המוצרים
        </button>
        <button
          onClick={() => navigate('/branches')}
          className="bg-gray-800 text-blue-400 font-bold text-base py-3.5 rounded-xl border-2 border-blue-600 hover:bg-gray-700 active:scale-95 transition-all"
        >
          🏪 רשימת הסניפים
        </button>
      </div>
      ...
      {/* Proof Strip */}
      <div className="flex justify-around items-center py-6 border-y border-gray-700 mb-8">
        {[
