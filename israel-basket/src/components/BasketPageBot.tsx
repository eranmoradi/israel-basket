...
const QA = [
  {
    ...
    answer:
      'כאן תראו את כל המוצרים שהוספתם לסל, המחיר הממשלתי הכולל בקרפור, ולצד כל מוצר — הרשת הזולה ביותר לאותו מוצר מבין שופרסל, רמי לוי ויוחננוף.',
  },
  {
    id: 'saving',
    question: 'כמה חוסכים',
  ...
  },
  {
    ...
    answer:
      'עד 2 יחידות מכל מוצר בכל קנייה. המחירים תקפים בסניפי קרפור מרקט והיפר בלבד — לא בסיטי. מחירי הרשתות מתעדכנים מדי יום ועשויים להשתנות.',
  },
]
