...
const QA = [
  {
    ...
    answer:
      'כאן תראה את כל המוצרים שהוספת לסל, המחיר הממשלתי הכולל בקארפור, ולצד כל מוצר — הרשת הזולה ביותר לאותו מוצר מבין שופרסל, רמי לוי ויוחננוף.',
  },
  {
    id: 'saving',
    question: 'כמה חוסכים',
  ...
  },
  {
    ...
    answer:
      'אם אחת הרשתות לא מוצאת מחיר לחלק מהמוצרים שלך, ההשוואה תהיה חלקית ותוצג באפור. כדאי להוסיף מוצרים נוספים כדי לקבל תמונה מלאה יותר.',
  },
  {
    id: 'limits',
